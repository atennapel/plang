...
function show(x) {
  ...
  return `${x}`;
};Void = impossible;Z = makeConstr('Z', 0);S = makeConstr('S', 1);Nil = makeConstr('Nil', 0);Cons = makeConstr('Cons', 2);A = makeConstr('A', 1);main = A((x => Cons(x)(Nil)));console.log(show(main));