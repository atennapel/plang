...
import { tvar, isTEffsEmpty, tfun, teffs, tapps, teffsFrom, tfunps, tforallps, tcomp, tforalls, tpure } from "./il/types";
...
export const _context = initialContext.add(
  ...
  cvar(name('caseMaybe'), tforalls([[name('t'), kType], [name('r'), kType]],
    tpure(tfunps(tvar(name('r')), tfunps(tvar(name('t')), tvar(name('r'))), tapps(tvar(name('Maybe')), tvar(name('t'))), tvar(name('r')))))),
  ...
  cvar(name('caseList'), tforalls([[name('t'), kType], [name('r'), kType]],
    tpure(tfunps(tvar(name('r')), tfunps(tvar(name('t')), tapps(tvar(name('List')), tvar(name('t'))), tvar(name('r'))), tapps(tvar(name('List')), tvar(name('t'))), tvar(name('r')))))),
