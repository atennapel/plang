...
import Type, { tforall, isTVar, isTMeta, isTForall, isTApp, tapp, isTRowEmpty, isTRowExtend, trowextend, isTComp, tcomp, isTEffsEmpty, isTEffsExtend, teffsextend } from './types';
